...
# 2. For each attack:
#    a. Calls `exam_attack_v2.py` to generate a unique PDF variant.
...
from exam_attack_v2 import create_exam_variant
...
def run_full_experiment():
    ...
    attacks_to_run = [
        ...
        # --- NEW TIER: SYMBOL STRETCHING ---
        {
            'name': 'D1_stretch_equals',
            'type': 'symbol_stretch',
            'params': {'target': '=', 'stretch_amount': 2.0}
        },
