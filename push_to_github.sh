...
if [ $? -eq 0 ]; then
    ...
    echo "The push failed, likely due to authentication issues."
    echo ""
    ...
    echo "   ./setup_github_auth.sh"
    echo ""
    echo "2. After setting up authentication, run this script again:"
    echo "   ./push_to_github.sh"
    echo ""
    echo "For direct authentication, you can also try:"
